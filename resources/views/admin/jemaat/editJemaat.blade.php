...
<div class="min-h-full">
    ...
    <div class="pt-28 w-3/5 max-w-full mx-auto">
        <h1 class="text-2xl font-bold text-center">Edit Jemaat</h1>
    </div>

<form class="py-4 w-3/5 max-w-full mx-auto" method="POST" action="{{ route('jemaat.update', $jemaat->id) }}">
    @csrf
    @method('put')
    ...
    <div class="relative z-0 w-full mb-5 group">
        <input type="text" name="alamat" value="{{$jemaat->alamat}}" id="floating_repeat_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
    ...
    <div class="relative z-0 w-full mb-5 group">
        <input type="number" name="noHp" value="{{$jemaat->noHp}}" id="floating_repeat_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
    ...
    <div class="grid md:grid-cols-2 md:gap-6">
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" name="tempatLahir" value="{{$jemaat->tempatLahir}}" id="floating_first_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" name="tanggalLahir" value="{{$jemaat->tanggalLahir}}" id="floating_last_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
    ...
    <div class="py-1">
        <button type="submit" onclick="history.back()" class="w-full  bg-slate-600 text-white font-semibold py-2 rounded-md hover:bg-slate-700">
